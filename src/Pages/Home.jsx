...
const SOCIAL_LINKS = [
        ...
        {
                icon: Linkedin,
                link: 'https://www.linkedin.com/in/dang-hoang-ha-b08925257/',
        },
        { icon: Instagram, link: 'https://www.instagram.com/hha.297/' },
];
                                                ...
                                                >
                                                        <div className="space-y-4 sm:space-y-6">
                                                                ...
                                                                <p
                                                                        ...
                                                                        data-aos-delay="1000"
                                                                >
                                                                        Creating Innovative, Functional, and
                                                                ...
                                                                {/* CTA Buttons */}
                                                                <div
                                                                        className="flex flex-row gap-3 w-full sm:justify-start  justify-center"
                                                                        data-aos="fade-up"
                                                                        data-aos-delay="1400"
                                                                >
                                                                        <CTAButton
