...
export const projectsData = [
        {
                id: 'mindspace',
                Img: Mindspace,
                Title: "Mindspace (OAMK's Thesis Project)",
                Description:
                        'A comprehensive mental health platform specifically designed for students and young adults. Features AI-powered chat support, mood tracking, journaling, stress assessments, educational resources, and community features. Built with modern tech stack including Next.js 15, TypeScript, MongoDB, and OpenAI integration.',
                Link: 'https://mindspace-three.vercel.app/',
                github: 'https://github.com/mindspace-tech/Mindspace',
                TechStack: [
                        'Next.js',
                        'React',
                        'TypeScript',
                ...
                Features: [
                        '🧠 AI-Powered Chat Support: 24/7 compassionate AI assistant trained for student mental health',
                        '📊 Mood Tracking: Comprehensive mood monitoring with analytics and insights',
                        '📝 Digital Journaling: Secure journaling platform with prompts and reflection tools',
                        '📋 Stress Assessment: Interactive quizzes and mental health screening tools',
                        '📚 Educational Resources: Curated articles, videos, and professional content',
                        '👥 Community Features: Safe, moderated peer support groups and anonymous sharing',
                        '🔒 Privacy & Security: End-to-end encryption and HIPAA-compliant data handling',
                        '📱 Mobile Ready: Responsive design optimized for all devices',
                        '🎨 Modern UI: Clean, intuitive interface with accessibility features',
                        '⚡ Performance Optimized: SSR/SSG with Next.js 15 and Turbopack',
                        ...
                        '🎯 Student-Focused: Designed specifically for academic life challenges',
                        '🌟 Evidence-Based: All tools grounded in proven mental health practices',
                        '🚀 Scalable Architecture: Modern system design for growth',
