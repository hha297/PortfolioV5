                ...
                <div className="grid grid-cols-2 gap-3 md:gap-4 p-3 md:p-4 bg-[#0a0a1a] rounded-xl overflow-hidden relative">
                        ...
                        <div className="relative z-10 flex items-center space-x-2 md:space-x-3 bg-white/5 p-2 md:p-3 rounded-lg border border-purple-500/20 transition-all duration-300 hover:scale-105 hover:border-purple-500/50 hover:shadow-lg">
                                ...
                                <div className="flex-grow">
                                        ...
                                        <div className="text-[10px] md:text-xs text-gray-400">Feature Count</div>
                                </div>
                        </div>
                </div>
        );
        ...
        useEffect(() => {
                ...
                if (selectedProject) {
                        const enhancedProject = {
                                ...
                                Github: selectedProject.github || 'https://github.com/hha297',
                        };
                                                ...
                                                <div className="space-y-6 md:space-y-10 animate-slideInRight">
                                                        <div className="relative rounded-2xl overflow-hidden border border-white/10 shadow-2xl group">
                                                                ...
                                                                <img
                                                                        src={project.Img}
                                                                        alt={project.Title}
                                                                        className="w-full h-96  object-cover transform transition-transform duration-700 will-change-transform group-hover:scale-105"
